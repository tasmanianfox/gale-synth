#ifndef _GALE_SYNTH_UI_WINDOW_MAIN_NEW_CONNECTION_WIDGET_H_
#define _GALE_SYNTH_UI_WINDOW_MAIN_NEW_CONNECTION_WIDGET_H_
...
#include "synth/ui/window_main/node_port_widget.hpp"
